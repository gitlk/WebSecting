...
jq('#loupan_banner').banqh({
	box:"#loupan_banner",//总框架
	pic:"#ban_pic1",//大图框架
	pnum:"#ban_num1",//小图框架
...
jq('#ershoufang_banner').banqh({
	box:"#ershoufang_banner",//总框架
	pic:"#esf_pic1",//大图框架
	pnum:"#esf_pic2",//小图框架
	prev_btn:"#esf_prev_btn1",//小图左箭头
	next_btn:"#esf_next_btn2",//小图右箭头
	prev:"#esf_prev_btn1",//大图左箭头
	next:"#esf_next_btn2",//大图右箭头
	autoplay:true,//是否自动播放
	interTime:2000,//图片自动切换间隔
	delayTime:600,//切换一张图片时间
	//pop_delayTime:400,//弹出框切换一张图片时间
	order:0,//当前显示的图片（从0开始）
